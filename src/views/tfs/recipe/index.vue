  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="订单状态" align="center" prop="orderStatus">
        <template slot-scope="scope">
          <dict-tag
            :options="dict.type.tfs_order_status"
    ...
    <el-dialog :title="title" :visible.sync="open" width="900px" append-to-body>
      <el-descriptions title="检测单">
        <el-descriptions-item
          ...
          :label="item.checkupIndicatorName"
          :key="item.checkupIndicatorId"
        >
      ...
      <el-descriptions title="订单详情">
        ...
        <el-descriptions-item label="图片">
          <el-image style="width: 100px; height: 100px" :src="soilUrl" :preview-src-list="[soilUrl]"></el-image>
        </el-descriptions-item>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="施肥建议" prop="fertilizationAdvice">
          <el-input
            v-model="form.fertilizationAdvice"
            placeholder="请输入施肥建议"
          />
        </el-form-item>
        <el-form-item label="种植建议" prop="plantingAdvice">
          <el-input
            v-model="form.plantingAdvice"
            placeholder="请输入种植建议"
          />
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitForm" v-if="showSubmitButton"
          >确 定</el-button
        >
